...
DEFAULT_TARGETS: dict[str, str] = {
    ...
    "collector-kraken": "http://collector-kraken:8000/health",
    "collector-binance-futures": "http://collector-binance-futures:8000/health",
    "collector-defillama": "http://collector-defillama:8000/health",
    "collector-github": "http://collector-github:8000/health",
